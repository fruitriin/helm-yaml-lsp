 ...
 */
export function findAllValuesReferences(document: TextDocument): ValuesReference[] {
 ...
 * @returns Array of ValuesReference objects
 */
function findAllValuesReferencesInLine(line: string, lineNumber: number): ValuesReference[] {
  const references: ValuesReference[] = [];
