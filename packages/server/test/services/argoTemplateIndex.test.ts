...
`;
			...
			const template1 = await index.findTemplate(
				'multi-template-workflow',
				'template1',
				false,
			);
			const template2 = await index.findTemplate(
				'multi-template-workflow',
				'template2',
				false,
			);
			const template3 = await index.findTemplate(
				'multi-template-workflow',
				'template3',
				false,
			);
...
`;
			...
			const oldTemplate = await index.findTemplate(
				'update-workflow',
				'old-template',
				false,
			);
...
`;
			...
			const oldTemplateLookup = await index.findTemplate(
				'update-workflow',
				'old-template',
				false,
			);
			const newTemplate = await index.findTemplate(
				'update-workflow',
				'new-template',
				false,
			);
...
`;
			...
			const templateBefore = await index.findTemplate(
				'remove-workflow',
				'remove-template',
				false,
			);
			...
			const templateAfter = await index.findTemplate(
				'remove-workflow',
				'remove-template',
				false,
			);
...
`;
			...
			const workflow = await index.findWorkflowTemplate(
				'workflow-metadata',
				false,
			);
...
`;
			...
			const template = await index.findTemplateByName(
